...
description: Drafts structured pull request descriptions from diffs and context: purpose, approach, impacted systems, testing, risks, dependencies, rollout, and links to tickets or ADRs for reviewer clarity and traceability. Use when creating pull requests, generating implementation summaries, documenting code changes, preparing review context, documenting rollout considerations, summarizing completed work, linking Jira stories and dependencies, or preparing production-ready PRs.
---
